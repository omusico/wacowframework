 ...
 * @version    $Id: Smarty.php 406 2008-04-20 02:43:18Z jaceju $
 */
 ...
 * @see Smarty
 */
require_once 'Wacow/View/Html/Smarty/core/Smarty.class.php';
...
class Wacow_View_Html_Smarty extends Wacow_View_Html
{
    ...
    {
        return (bool) $this->_smarty->is_cached($template);
    }
