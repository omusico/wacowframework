...
/**
 * Wacow_Application_Plugin_ActionHelperManager
 *
 * @category   Wacow
 * @package    Wacow_Application
 * @subpackage Wacow_Application_Plugin
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Wacow_Application_Plugin_ActionHelperManager extends Wacow_Application_Plugin_Abstract
{
    /**
     * Set action controller helpers
     *
     */
    public function beforeRun()
    {
        Zend_Controller_Action_HelperBroker::addPrefix('Wacow_Controller_Action_Helper');
