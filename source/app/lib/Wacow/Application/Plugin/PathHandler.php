...
class Wacow_Application_Plugin_PathHandler extends Wacow_Application_Plugin_Abstract
{
    ...
    {
        $this->_app->publicPath             = $this->_app->translatePath($this->_app->publicPath);
        $this->_app->config->common->module = $this->_app->translatePath($this->_app->config->common->module);
        $this->_app->config->common->view   = $this->_app->translatePath($this->_app->config->common->view);
    }
}